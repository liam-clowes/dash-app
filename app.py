...
fig4 = fig4.update_layout(
        plot_bgcolor="#060606", paper_bgcolor="#060606", font_color="#ffad8e"
    )
...
fig8 = px.scatter_mapbox(df_geo2,
                        ...
                        color='city',
                        color_discrete_map={'Berlin': '#fd7e14', 'Tokyo': '#fbc02d', 'Wellington': '#ffcc80'},
                        title="Scatter Map of Average Monthly Temperatures: April 2023 - April 2024, All Locations",
...
# Set fixed width for tables and graphs
table_graph_width = '800px'
...
app.layout = html.Div([
    ...
    html.Div([
        html.Div('Berlin', style={'backgroundColor': '#fd7e14', 'color': 'black'}),
        html.Div(table1, style={'width': table_graph_width, 'marginLeft': 'center', 'marginRight': 'center'}),
        html.Div(graph1, style={'width': table_graph_width, 'marginLeft': 'center', 'marginRight': 'center'}),
    ]),
    html.Div([
        html.Div('Tokyo', style={'backgroundColor': '#fbc02d', 'color': 'black'}),
        html.Div(table2, style={'width': table_graph_width, 'marginLeft': 'center', 'marginRight': 'center'}),
        html.Div(graph2, style={'width': table_graph_width, 'marginLeft': 'center', 'marginRight': 'center'}),
    ]),
    html.Div([
        html.Div('Wellington', style={'backgroundColor': '#ffcc80', 'color': 'black'}),
        html.Div(table3, style={'width': table_graph_width, 'marginLeft': 'center', 'marginRight': 'center'}),
        html.Div(graph3, style={'width': table_graph_width, 'marginLeft': 'center', 'marginRight': 'center'}),
    ]),
    html.Div([
        html.Div('All Locations', style={'backgroundColor': '#ffad8e', 'color': 'black'}),
        html.Div(graph4, style={'width': table_graph_width, 'marginLeft': 'center', 'marginRight': 'center'}),
        html.Div(graph5, style={'width': table_graph_width, 'marginLeft': 'center', 'marginRight': 'center'}),
        html.Div(graph6, style={'width': table_graph_width, 'marginLeft': 'center', 'marginRight': 'center'}),
        html.Div(graph7, style={'width': table_graph_width, 'marginLeft': 'center', 'marginRight': 'center'}),
        html.Div(graph8, style={'width': table_graph_width, 'marginLeft': 'center', 'marginRight': 'center'}),
        ]),
])
